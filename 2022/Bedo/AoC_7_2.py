...
if __name__ == "__main__":
    ...
    smallest_dir = tot_space

    unused_space = tot_space - dirs[-1] 

    for value in dirs:
        if int(value) + unused_space >= space_to_have and int(value) < smallest_dir:
            smallest_dir = int(value)
